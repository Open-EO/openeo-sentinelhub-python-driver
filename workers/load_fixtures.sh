...
curl -s "https://services.sentinel-hub.com/ogc/wcs/${SENTINELHUB_INSTANCE_ID}?SERVICE=wcs&MAXCC=100.0&ShowLogo=False&Transparent=True&EvalScript=cmV0dXJuIFtCMDEsQjA0XQ%3D%3D&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&FORMAT=image%2Ftiff%3Bdepth%3D32f&CRS=EPSG%3A4326&TIME=2019-08-17T10%3A19%3A14%2F2019-08-17T10%3A19%3A14&RESX=10m&RESY=10m&COVERAGE=S2L1C&REQUEST=GetCoverage&VERSION=1.1.2" > tests/fixtures/response_load_collection_bands_s2l1c.tiff
...
curl -s "https://services.sentinel-hub.com/ogc/wcs/${SENTINELHUB_INSTANCE_ID}?SERVICE=wcs&MAXCC=100.0&ShowLogo=False&Transparent=True&EvalScript=cmV0dXJuIFtWVl0%3D&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&FORMAT=image%2Ftiff%3Bdepth%3D32f&CRS=EPSG%3A4326&TIME=2019-08-17T05%3A19%3A10%2F2019-08-17T05%3A19%3A10&RESX=10m&RESY=10m&COVERAGE=S1GRD&REQUEST=GetCoverage&VERSION=1.1.2" > tests/fixtures/response_load_collection_bands_s1grdiw.tiff
