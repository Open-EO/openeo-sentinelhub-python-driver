...
# S2L1C for bands:
curl -s "https://services.sentinel-hub.com/ogc/wfs/7faf6ba7-6434-45f5-9532-3350c4aa35db?SERVICE=wfs&REQUEST=GetFeature&TYPENAMES=S2.TILE&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&OUTPUTFORMAT=application%2Fjson&SRSNAME=EPSG%3A4326&TIME=2019-08-16T00%3A00%3A00%2F2019-08-18T23%3A59%3A59&MAXCC=100.0&MAXFEATURES=100&FEATURE_OFFSET=0" > tests/fixtures/response_load_collection_bands_s2l1c.json
curl -s "https://services.sentinel-hub.com/ogc/wcs/7faf6ba7-6434-45f5-9532-3350c4aa35db?SERVICE=wcs&MAXCC=100.0&ShowLogo=False&Transparent=True&EvalScript=cmV0dXJuIFtCMDEsQjA0XQ%3D%3D&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&FORMAT=image%2Ftiff%3Bdepth%3D32f&CRS=EPSG%3A4326&TIME=2019-08-17T10%3A19%3A14%2F2019-08-17T10%3A19%3A14&RESX=10m&RESY=10m&COVERAGE=S2L1C&REQUEST=GetCoverage&VERSION=1.1.2" > tests/fixtures/response_load_collection_bands_s2l1c.tiff

# S1GRD for bands:
curl -s "https://services.sentinel-hub.com/ogc/wfs/7faf6ba7-6434-45f5-9532-3350c4aa35db?SERVICE=wfs&REQUEST=GetFeature&TYPENAMES=DSS3&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&OUTPUTFORMAT=application%2Fjson&SRSNAME=EPSG%3A4326&TIME=2019-08-16T00%3A00%3A00%2F2019-08-17T05%3A19%3A11&MAXCC=100.0&MAXFEATURES=100&FEATURE_OFFSET=0" > tests/fixtures/response_load_collection_bands_s1grdiw.json
curl -s "https://services.sentinel-hub.com/ogc/wcs/7faf6ba7-6434-45f5-9532-3350c4aa35db?SERVICE=wcs&MAXCC=100.0&ShowLogo=False&Transparent=True&EvalScript=cmV0dXJuIFtWVl0%3D&BBOX=42.06347%2C12.32271%2C42.07112%2C12.33572&FORMAT=image%2Ftiff%3Bdepth%3D32f&CRS=EPSG%3A4326&TIME=2019-08-17T05%3A19%3A10%2F2019-08-17T05%3A19%3A10&RESX=10m&RESY=10m&COVERAGE=S1GRD&REQUEST=GetCoverage&VERSION=1.1.2" > tests/fixtures/response_load_collection_bands_s1grdiw.tiff
