...
def execute_mean_process(generate_data):
    def wrapped(data_arguments={}, ignore_nodata=None):
        ...
        return process.mean.meanEOTask(None, "", None, {}, "node1", {}).process(arguments)
...
@pytest.mark.parametrize(
    ...
    [([1, 0, 3, 2], True, 1.5), ([9, 2.5, None, -2.5], True, 3), ([1, None], False, None), ([], True, None)],
)
...
def test_with_xarray_nulls(
    execute_mean_process, generate_data, data, expected_data, expected_dims, attrs, ignore_nodata
):
    """
