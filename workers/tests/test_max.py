...
@pytest.mark.parametrize(
    ...
    [([1, 0, 3, 2], True, 3), ([5, 2.5, None, -0.7], True, 5), ([1, 0, 3, None, 2], False, None), ([], True, None)],
)
...
def test_with_xarray_nulls(
    execute_max_process, generate_data, data, expected_data, expected_dims, attrs, ignore_nodata
):
    """
